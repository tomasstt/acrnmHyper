...
<template><div class="black">
	...
	export default {
	  data() {
		return {
		  images: [
		   require('../assets/Slids2.svg'),
		   require('../assets/Slids2.svg'),require('../assets/Slids2.svg'),
		   require('../assets/Slids2.svg'),  require('../assets/Slids2.svg'),require('../assets/Slids2.svg'),
		   require('../assets/Slids2.svg'),require('../assets/Slids2.svg'),
		   require('../assets/Slids2.svg'),  require('../assets/Slids2.svg'),require('../assets/Slids2.svg'),
		   require('../assets/Slids2.svg'),require('../assets/Slids2.svg'),
		   require('../assets/Slids2.svg'),  require('../assets/Slids2.svg'),require('../assets/Slids2.svg'),
