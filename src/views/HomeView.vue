<template>
	<div id="Acronym" class="background" data-scroll-container>
		...
		<div id="Team"  class="three-column-layout">
			<div  class="column1">
				<p class="tech">Backend</p>
				<p class="description">The server, the database, and the application. It's all about the functionality, security, and data management.</p>

				<p class="small">A.J.M</p>
			</div>

			<div class="column2">
				<p class="tech">Frontend</p>
				<p class="description">The part of the web users see and interact with. It combines design, technology, and experience for the best user journey.</p>

				<p  class="small">T.T</p>
			</div>
			<div class="column3">
				<p class="tech">Design</p>
				<p class="description">More than just aesthetics. It's about usability, accessibility, and creating the perfect user flow.</p>
