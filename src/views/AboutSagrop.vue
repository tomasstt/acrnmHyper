<template>
	<div class="full-screen-container scroll-container">
		<img class="head-img" src="../assets/sagrop.svg" alt="Fullscreen Background" />
			...
			<div class="info-content">
				<div class="flex-container">
					<div class="description-side">
						...
						<h1>Sagrop, spol. s R.o. Sala is a distributor and consulting firm that provides the sale of inputs to primary agricultural production with the offer of refinancing until the harvest of the relevant plant commodity.</h1>
					</div>
					<main class="main-content">
						<div class="team-info-container">
							<p class="description">Implements the purchase of agricultural commodities and expert advice with the possibility of inspection of our varietal semi-operational trials.</p>
...
export default {
	...
	data() {
		return {
			activeLink: null,
			links: [
				{ id: 1, label: "Visit site", url: "https://sagrop.sk/" },
				{ id: 2, label: "Close" },
			],
		}
	},
